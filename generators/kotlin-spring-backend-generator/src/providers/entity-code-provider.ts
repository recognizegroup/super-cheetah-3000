...
export class EntityCodeProvider extends BaseProvider {
    async generate(context: EntityContext): Promise<void> {
        ...
        await this.renderer.addFile('entity/__DTO.kt.njk', `${directory}/src/main/kotlin/${packageName.replace(/\./g, '/')}/model/${pascalCase}DTO.kt`);
        await this.renderer.addFile('entity/__Entity.kt.njk', `${directory}/src/main/kotlin/${packageName.replace(/\./g, '/')}/entity/${pascalCase}.kt`);
        await this.renderer.addFile('entity/__Repository.kt.njk', `${directory}/src/main/kotlin/${packageName.replace(/\./g, '/')}/repository/${pascalCase}Repository.kt`);
        await this.renderer.addFile('entity/__Controller.kt.njk', `${directory}/src/main/kotlin/${packageName.replace(/\./g, '/')}/controller/${pascalCase}Controller.kt`);
        await this.renderer.addFile('entity/__ControllerTest.kt.njk', `${directory}/src/test/kotlin/${packageName.replace(/\./g, '/')}/controller/${pascalCase}ControllerTest.kt`);
        await this.renderer.addFile('entity/__test_fixture.sql.njk', `${directory}/src/test/resources/fixtures/${StringModificationHelper.toKebabCase(entity.name)}.sql`);
