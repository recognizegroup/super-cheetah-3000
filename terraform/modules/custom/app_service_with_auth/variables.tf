...
variable "auth_enabled" {
    type        = bool
    description = "Enable authentication for this web app."
    default     = false
}

variable "require_authentication" {
    type        = bool
    description = "Require authentication for this web app."
    default     = false
}

variable "unauthenticated_action" {
    type = string
    description = "Action to take when request is not authenticated."
    default = "Return401"
}

variable "ad_auth_settings" {
    type = object({
            client_id = string,
