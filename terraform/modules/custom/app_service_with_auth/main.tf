  ...
  dynamic "auth_settings_v2" {
    ...
    content {
        ...
        dynamic "active_directory_v2" {
            for_each = var.ad_auth_settings != null ? [1] : []

            content {
                client_id = var.ad_auth_settings.client_id
                client_secret_setting_name = var.ad_auth_settings.client_secret_setting_name
                tenant_auth_endpoint = var.ad_auth_settings.tenant_auth_endpoint
            }
        }
